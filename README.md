...
* Python 3.5 +(should not use version above 3.12 because tensorFlow is yet not compatible)
...
Unzip the **dataset.zip** file and place them in the respected folders.
